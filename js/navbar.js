...
(function () {
  ...
  if (!user) {
    container.innerHTML = `
      <nav class="navbar">
        ${logoHTML('pages/index.html', 'DevVerse')}

        <!-- Desktop links (hidden on mobile via CSS) -->
        <div class="navbar-links--desktop">
          <a href="${prefix}../../pages/index.html"       class="nav-link ${active('index')}">Home</a>
      ...
      <div class="mobile-menu" id="mobile-menu">
        <a href="${prefix}../../pages/index.html"       class="mobile-menu__item ${active('index')}">Home</a>
