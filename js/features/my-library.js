...
function buildLibraryCard(book) {
    ...
    // Card is now a clickable link to the detail page (No 'Read Now' button)
    return `
        <a href="book-detail.html?id=${book.id}" class="book-card" style="text-decoration: none; color: inherit;">
